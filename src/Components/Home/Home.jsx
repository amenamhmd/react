...
export default function Home() {
  return (
    ...
    <div className="flex flex-col items-center min-h-screen  bg-[#1ABC9C]  pt-20">
 
  <img src={avatar} alt="avatar" className="w-70 h-70 mb-4" />

  <h2 className="text-white text-3xl font-bold mb-4">START FRAMEWORK</h2>
